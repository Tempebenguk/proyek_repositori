...
@section('contents')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div>
                <a href="{{ route('admin.dosen.tambah') }}" class="btn btn-primary" style="margin-bottom: 10px;">Tambah
                    Data</a>
            </div>
                ...
                <tbody>
                    @foreach ($dosen as $dsn)
                        <tr>
                            ...
                            <td>{{ $dsn->password }}</td>
                            <td>
                                <img src="{{ asset('storage/' . $dsn->foto) }}" alt="Foto Dosen"
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.dosen.hapus', $dsn->id) }}"
